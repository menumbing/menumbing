 ...
 */
class OAuth2UserGuard implements OAuth2GuardInterface
{
    ...
    )
    {
        ...
        $this->clientProvider = $this->getClientProvider(
            $this->config->get('oauth2-resource-server.client.provider', 'stateless')
        );
    ...
    protected function getClientProvider(string $name): ClientProviderInterface
    {
        return $this->container->get(
            $this->config->get('oauth2-resource-server.client.providers.' . $name),
        );
    }
